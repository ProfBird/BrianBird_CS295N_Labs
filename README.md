...
This was originally a .NET 6.0 web app, but branches for labs 1 through 5 have now been upgraded to .NET 10 and tested in Visual Studio 2026.
...
- Lab1: Just an ASP.NET 10.0 MVC web site created from the Visaul Studio 2022 template. The home page has been edited to show the name of the new web site.
...
- Lab4: Added Bootstrap styling to the message entry form.
- Lab5: Added a quiz and unit tests.
